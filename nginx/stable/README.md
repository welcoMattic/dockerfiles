...
## ImageLayer
* 1.9.13 [![](https://badge.imagelayers.io/xataz/nginx:latest.svg)](https://imagelayers.io/?images=xataz/nginx:latest 'Get your own badge on imagelayers.io')
...
## Tag available
* latest, mainline, 1.9, 1.9.13 [(Dockerfile)](https://github.com/xataz/dockerfiles/blob/master/nginx/1.9.13/Dockerfile)
