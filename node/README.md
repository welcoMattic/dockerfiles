...
## Tag available
* latest, 5.9.0, 5.7, 5 [(Dockerfile)](https://github.com/xataz/dockerfiles/blob/master/node/5.7.0/Dockerfile)
* latest-onbuild, 5.9.0-onbuild, 5.7-onbuild, 5-onbuild, onbuild [(Dockerfile)](https://github.com/xataz/dockerfiles/blob/master/node/5.7.0-onbuild/Dockerfile)
...
```shell
docker build -t xataz/node:5.9.0 github.com/xataz/dockerfiles.git#master:node/5.7.0
```
