...
* Automatic certificate generation and renew (with letsencrypt)
...
| reverse.frontend.ssltype | Choose ssl type | ec384 | rsa2048, rsa4096, rsa8192, ec256 or ec384 (only with letsencrypt, selfsigned is rsa 4096) |
